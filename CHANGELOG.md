...
- **AMB type-Tag erweitert**: `packages/tab-oer-shares` schreibt für kind:30142 jetzt zwei `type`-Tags (`['type', 'LearningResource']`, `['type', 'ImageObject']`) statt nur `LearningResource`.
